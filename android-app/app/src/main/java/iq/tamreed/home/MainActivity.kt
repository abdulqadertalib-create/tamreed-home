...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRequestScreen() {
        ...
        // تم إلغاء اختيار التاريخ والوقت.
        // الطلب أصبح فوريًا، ويُرسل مباشرة بعد تأكيد البيانات.
        ...
        addButton(
            ...
            if (
                selectedPosition < 0 ||
                selectedPosition >= loadedServices.size
            ) {
            ...
            val selectedService =
                loadedServices[selectedPosition]
    ...
    private fun createBooking(
        ...
        scope.launch {
            ...
            try {
                ...
                // لا يوجد موعد للزيارة.
                // نخزن وقت إنشاء الطلب فقط في scheduled_at للتوافق مع قاعدة البيانات الحالية.
