...
class NurseLoginActivity : AppCompatActivity() {
    ...
    private fun showPhoneScreen() {
        ...
        root.addView(makeText("🩺", 58f, NAVY))
        root.addView(makeText("دخول الممرض", 30f, NAVY, true))
        root.addView(
            makeText(
        ...
        val card = LinearLayout(this).apply {
            ...
            setPadding(dp(18), dp(25), dp(18), dp(25))
        }

        card.addView(makeText("📱", 45f, NAVY))
        card.addView(
            makeText(
                "رقم هاتف الممرض",
                20f,
    ...
    private fun showOtpScreen() {
        ...
        root.addView(makeText("🔐", 55f, NAVY))
        root.addView(
            makeText(
                "تأكيد رقم الممرض",
                28f,
        ...
        root.addView(code, LinearLayout.LayoutParams(-1, dp(70)))
    ...
    private fun verifyOtp(token: String) {
        ...
        scope.launch {
            try {
                ...
                // بعد نجاح OTP ننتقل مباشرة لفحص الحساب.
                checkNurseAndContinue()
